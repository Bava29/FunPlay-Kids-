document.addEventListener("DOMContentLoaded", () => {
    ...
    if (fills.length && whyChooseSection) {
    ...
    if (!page1 || !page2 || !btn || !heading) return;
    ...
    btn.addEventListener("click", () => {
        ...
        if (activitiesSection) {
            ...
            const targetTop = activitiesSection.getBoundingClientRect().top + window.scrollY - headerOffset;
